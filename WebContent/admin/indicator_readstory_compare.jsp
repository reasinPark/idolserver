...
<H2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2화이상 읽은 이야기간 수 비</H2>
<section>
	<H3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이야기별 같이 읽은 이야기 카운트</H3>
</section>
	<%
	String filepath = "";
	String filename = "";
	...
	<form action="indicator_readstory_compare" method="post">
	...
	try {
		if(type != null) {
			...
			filename = "story_readstory_compare.csv";
			fw = new FileWriter(filepath+filename);

			conn = ConnectionProvider.getConnection("logdb");
			pstmt = conn.prepareStatement("select date_format(regdate, '%Y-%m-%d'), mainstory,substory,count from user_storyrelation where regdate between ? and ?");
			...
			while(rs.next()) {
				...
				String mainstory = rs.getString(2);
				String substory = rs.getString(3);
