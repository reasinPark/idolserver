...
<form target="result_frame" action="csvupload_photopage_update.jsp" method="post" id="item_form" enctype="Multipart/form-data">
	<table border = "1" style="border-style:solid;">
		<tr>
			<td> 적용할 photopage.csv 파일 </td>
			<td><input type="file" name="photopage" /></td>
		</tr>
		<tr>
...
<%
	try {
		...
		PreparedStatement pstmt = conn.prepareStatement("select photopageid,thumbnail,mainimg,name from photopage");
