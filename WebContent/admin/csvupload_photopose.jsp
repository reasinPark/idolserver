...
<H2>&nbsp;&nbsp;&nbsp;&nbsp;csv 파일 적용</H2>
<section>
	<H3 style="font-size:100">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;화보 포즈 데이터</H3>
</section>

<form target="result_frame" action="csvupload_photopose_update.jsp" method="post" id="item_form" enctype="Multipart/form-data">
	<table border = "1" style="border-style:solid;">
		<tr>
			<td> 적용할 photopose.csv 파일 </td>
			<td><input type="file" name="photopose" /></td>
		</tr>
		<tr>
...
<%
	try {
		...
		PreparedStatement pstmt = conn.prepareStatement("select ppid,ppname,thumbnail,ppaniname from photopose");
