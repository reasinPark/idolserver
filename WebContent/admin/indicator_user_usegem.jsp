...
<H2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이야기별 패션 아이템 사용 젬 수</H2>
<section>
	<H3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이야기별 패션 아이템 사용 젬 수</H3>
</section>
	<%
	String filepath = "";
	String filename = "";
	...
	<form action="indicator_user_usegem.jsp" method="post">
		...
		<input type="hidden" name="type" value="usegem">
	</form>
	...
	try {
		if(type != null) {
			...
			<form action="csvfiledownload.jsp" method="post">
				<input type="hidden" name="filename" value="use_usegem">
			...
			pstmt = conn.prepareStatement("select date_format(regdate, '%Y-%m-%d') m, storyid, count from user_usegem where regdate between ? and ?");
			pstmt.setTimestamp(1, start);
			pstmt.setTimestamp(2, end);
			rs = pstmt.executeQuery();
